        ...
        ToolRegistration(
            tool=types.Tool(
                ...
                description=(
                    ...
                    "• Call this tool again with the same data (duplicates are blocked server-side)\n"
                    "\n"
                    "⛔ **NEVER RETRY IF WIDGET DOESN'T APPEAR** ⛔\n"
                    "If the widget doesn't render immediately:\n"
                    "• This is a technical/display issue, NOT a tool failure\n"
                    "• The tool call succeeded - do NOT call it again\n"
                    "• Do NOT attempt to regenerate or recalculate\n"
                    "• Simply wait or tell the user the quote was generated\n"
                    "\n"
